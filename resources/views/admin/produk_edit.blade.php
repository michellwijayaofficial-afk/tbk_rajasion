            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="stock_produk" name="stock_produk" 
                                       value="{{ old('stock_produk', $produk->stock_produk) }}" min="0" required>
                            ...
                            <div class="form-group">
                                ...
                                @if($produk->foto_produk)
                                    <div class="mt-2">
                                        ...
                                        <img src="{{ asset('storage/' . $produk->foto_produk) }}" alt="Current Image" style="max-width: 150px; max-height: 150px; border: 1px solid #ddd; border-radius: 4px;">
                                    </div>
                                @endif
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="deskripsi_produk" name="deskripsi_produk" rows="4">{{ old('deskripsi_produk', $produk->deskripsi_produk) }}</textarea>
                    </div>
